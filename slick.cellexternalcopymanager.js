    ...
    */
    ...
    function init(grid) {
      ...
      cellSelectionModel.onSelectedRangesChanged.subscribe(function(e, args){
        //_grid.focus();    commented this out so that autoEdit still works.
      });
    }
    ...
    function _decodeTabularData(_grid, ta){
      ...
      for (var i=0; i<clipRows.length; i++) {
        ...
        //else
          //clippedRange[i] = [""];   took this statement out as it was adding empty row. this wasn't in original version I used. Need to work out if there are cases its needed.
      }
